...
import com.skan.jobportal.services.UsersTypeService;
...
//        return "dashboard"; // doest maps user model
        return "redirect:/dashboard/"; // this maps the user model to dashboard
    }
